...
import com.example.test.databinding.LanguageSettingsBinding
import com.example.test.retrofit.Language
import com.example.test.retrofit.NetworkResult
import com.example.test.viewModel.LanguageSettingsViewModel
...
class LanguageSettingsActivity: BaseActivity() {
    ...
    private fun setupUI() {
        ...
        binding.applyBtn.setOnClickListener {
            ...
            } ?: Toast.makeText(this, "言語が選択されていません", Toast.LENGTH_SHORT).show()
        }
    }
