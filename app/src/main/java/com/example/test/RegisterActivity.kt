...
import com.example.test.retrofit.RegisterViewModel
...
//            viewModel.progressBar.visibility = if (result is NetworkResult.Loading) View.VISIBLE else View.GONE
            ...
            if (result is NetworkResult.Success) {
                ...
                val token = (result.data as? com.example.test.retrofit.AuthResponse)?.accessToken
