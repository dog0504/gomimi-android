...
import com.example.test.retrofit.GarbageIdentificationResponse
...
class MainViewModel(private val repository: UserRepository = UserRepository()) : ViewModel() {
    ...
    // キーワードでごみの詳細（マニュアル）を検索する
//    fun fetchManualDetail(keyword: String) {
//        viewModelScope.launch {
//            _manualDetail.value = NetworkResult.Loading
//            _manualDetail.value = repository.searchManuals(keyword)
//        }
//    }
